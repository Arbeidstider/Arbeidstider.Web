...
namespace Arbeidstider.DataAccess.Repository
{
    public class TimesheetRepository : IRepository<ITimesheet>
    {
        ...
        {
            var dt = _database.GetMultiple<Timesheet>(StoredProcedures.GET_ALL_TIMESHEETS, parameters);
        ...
        {
            var dt = _database.Execute(StoredProcedures.CREATE_NEW_TIMESHEET, parameters);
        ...
        {
            var dt = _database.GetSingle<Timesheet>(StoredProcedures.GET_TIMESHEET, parameters);
        ...
        {
            return _database.Execute(StoredProcedures.DELETE_TIMESHEET, parameters);
        }
