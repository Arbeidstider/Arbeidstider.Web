namespace Arbeidstider.Web.ServiceInterfaces
{
    //[Authenticate]
    //public class TimesheetsService : Arbeidstider.ServiceInterfaces.ServiceBase
    //{
    ...
    //        int id = Arbeidstider.DataServices.TimesheetService.Instance.CreateTimesheet(
    //            request.EmployeeId,
    //            selectedDay,
    //            shiftStart,
    //            shiftEnd);
